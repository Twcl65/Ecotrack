...
export default function AboutScreen() {
  ...
  return (
    <View style={styles.screen}>
      <AppHeader title="About ECOTRACK" showBack showBell={false} />
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.aboutCard}>
          ...
          <Text style={styles.bodyText}>
            ECOTRACK is Jasaan's smart waste management platform, built to help the
            local government unit monitor collection routes, track active pickups, and
            generate insights for a cleaner, greener community. Together, we're
            building a sustainable future for Jasaan.
          </Text>
        </View>
        ...
        <View style={styles.servicesCard}>
          ...
          <Text style={styles.bodyText}>
            Comprehensive waste management solutions for Jasaan LGU — including route
            planning, collection scheduling, resident announcements, complaint handling,
            and analytics to support data-driven decisions.
          </Text>
        </View>
